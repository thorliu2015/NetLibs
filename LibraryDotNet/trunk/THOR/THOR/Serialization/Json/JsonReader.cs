...
namespace THOR.Serialization.JSON
{
	...
	public class JsonReader
	{
			...
			while (true)
			{
				...
				if (current_symbol == current_input)
				{
					if (!ReadToken())
					{
						...
						if (automaton_stack.Peek() != (int)ParserToken.End)
						{
							JsonException JsonEx = new JsonException("Input doesn't evaluate to proper JSON text");
							JsonEx.OwnerReader = reader;
				...
				catch (KeyNotFoundException e)
				{
					...
					JsonException JsonEx = new JsonException((ParserToken)current_input, e);
					JsonEx.OwnerReader = reader;
		...
		public TextReader TextReader { get { return reader; } }
	}
}
